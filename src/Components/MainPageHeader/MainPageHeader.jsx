...
export function MainPageHeader() {
    return (<><div className={styles.navBar}>
        ...
        <ul className={styles.headerList}>
            <li className={styles.navBarItem}><button className={styles.button}><a href="#" className={styles.href}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hdd-stack-fill" viewBox="0 0 16 16">
            ...
            <li className={styles.navBarItem}><button className={styles.button}><a href="#" className={styles.href}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
                <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3Zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"></path>
            </svg>Персонал</a></button></li>
            <li className={styles.navBarItem}><button className={styles.button}><a href="#" className={styles.href}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-credit-card-fill" viewBox="0 0 16 16">
            ...
            <li className={styles.navBarItem}><button className={styles.button}><a href="#" className={styles.href}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-right-dots-fill" viewBox="0 0 16 16">
